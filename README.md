...
To use: Run `spas-compose init <domain>` then run `spas-compose init <domain>` for each service you wish to use, and finally invoke the agent with `/spas.compose` in GitHub Copilot Chat.
