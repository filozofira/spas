...
docker build -t spas-examples/fulfillment-service-java:latest -f "$repoRoot/examples/services/fulfillment-service-java/Dockerfile" "$repoRoot/examples/services/fulfillment-service-java"