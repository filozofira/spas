...
- [X] T025 [P] [US3] Add unit tests for attribute description emission and omission in components/sdk/dotnet/test/Spas.Sdk.Metadata.Tests/SpasComposerTests.cs
- [X] T026 [P] [US3] Add unit tests for event description propagation in components/sdk/dotnet/test/Spas.Sdk.Metadata.Tests/ContractsBuilderTests.cs

### Implementation for User Story 3

- [X] T027 [P] [US3] Add Description property to command/query/event attributes in components/sdk/dotnet/src/Spas.Sdk.Metadata/Attributes/SpasContractAttributes.cs
- [X] T028 [US3] Add Description to EventContract model in components/sdk/dotnet/src/Spas.Sdk.Metadata/Models/MetadataModels.cs
- [X] T029 [US3] Thread event description through builder in components/sdk/dotnet/src/Spas.Sdk.Metadata/Builders/ContractsBuilder.cs
- [X] T030 [US3] Thread event description through discovery in components/sdk/dotnet/src/Spas.Sdk.Metadata/Discovery/MetadataDiscovery.cs
- [X] T031 [US3] Ensure endpoint discovery passes description when present in components/sdk/dotnet/src/Spas.Sdk.Metadata/Extensions/WebApplicationDiscoveryExtensions.cs
...
- [X] T032 [US4] Update description-first guidance and disambiguation rules in .github/agents/spas.compose.agent.md
- [X] T033 [US4] Add a small verification section (manual test steps) to specs/017-metadata-descriptions/quickstart.md

**NOTE**: The `.github/agents/spas.compose.agent.md` file is generated by `spas-compose init`.
Updating the checked-in file alone is not sufficient; the template used by the CLI must be updated as well.

- [X] T041 [US4] Update the agent prompt template generated by `spas-compose init` (generateAgentFile) to include description-first matching + quoting + no-invention rules in components/cli/spas-compose/src/utils/templates.ts
- [X] T042 [US4] Add/extend unit tests to validate the generated prompt includes the description-first rules in components/cli/spas-compose/test/unit/utils/templates.test.ts
...
- [X] T040 Run quickstart validation end-to-end and record outcomes in specs/017-metadata-descriptions/quickstart.md
