...
**Example Workflow**: *Service developer initializes service → defines spas.json and contracts → publishes to Repository → other domains can discover and compose the service*
...
**Example Workflow**: *Domain composer initializes workspace → pulls services from Repository → uses AI-assisted composition to analyze contracts and propose choreography → validates and builds deployment artifacts → runs docker-compose*
