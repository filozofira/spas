  ...
  return JSON.stringify(
    {
      ...
      description:
        "Schema for sidecar configuration files generated by spas-compose choreography deploy. Each service has a config.{serviceName}.json file mounted to the sidecar.",
      type: "object",
