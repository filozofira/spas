...
2. .specify/memory/constitution.md - GitHub SpecKit constitution file generated by copilot
3. ./README.md - SPAS framework overview and current achievements
4. ./principles/INDEX.md - Complete specification navigation
5. ./principles/appendix/28-decision-log.md - Architecture decisions (ADRs)
6. ./principles/02-architecture-overview.md - High-level system design
7. ./prototypes/spas-sidecar-prototype/README.md - Prototype documentation
