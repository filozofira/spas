...
|---|-------|-------------|-------|--------|
| 1 | DAPR HTTP Middleware | Research DAPR middleware execution order: confirm inbound transformation runs POST-subscription-routing, not pre. Risk: if negative, requires alternative approach (e.g., sidecar as separate container). | TBD | TODO |
